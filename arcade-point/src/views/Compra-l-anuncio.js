...
function CompraLAnuncios() {
    const navigate = useNavigate();

    const cadastrar = () => {
        navigate(`/Compra-c-anuncio`);
    };

    const editar = (id) => {
        navigate(`/Compra-c-anuncio/${id}`);
    };
    ...
    async function excluir(id) {
        ...
        await axios
            ...
            .catch(function (error) {
                mensagemErro(`Erro ao excluir o Anúncio`);
            });
    }
...
export default CompraLAnuncios;
