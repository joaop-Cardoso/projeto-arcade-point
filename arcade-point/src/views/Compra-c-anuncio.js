...
function CompraCAnuncio() {
  ...
  async function salvar() {
    let data = { id, idProduto, nomeCliente};
        ...
        <div className='row'>
          <div className='col-lg-12'>
            <div className='bs-component'>
              <FormGroup label='Anúncio: *' htmlFor='selectProduto'>
                <select
                ...
                <FormGroup label='Cliente: *' htmlFor='inputAnunciador'>
                    <input
                    type='text'
                    maxLength='11'
                    id='inputAnunciador'
